...
##### Our game trailer (OLD ONE): https://www.mcgill.ca/ludicmind/projects/road-ahead\
...
* Team Division: (not exclusive)
	* Game dev team: 
		* **Art Team** : Draw game assets: Objects, Portraits, Walking sprites, Tiles, UI, Splash images
			* Art team leaders: Michael
		* **Writing Team** : Write game assets, scripts, dialogue, events, quests, etc.
			* Writing team leaders: Aaron and Corina
		* **Implementation Team** : use Unity to implement game assets
			* Dev team leaders : Trent
	* Project team: 
		* **Research team. 
			* Go-to person if questions: Corina
		* **Socials team**
			* Go-to person: Aaron and Corina 
* Timeline: 
	* We use **Sprints**. *what are those?* -> [[TRA Meeting Sept 30th 2025]]
* Communication: On Discord!
* Hours expected: ~10h a week

*Interested in a specific team? Contact team leaders directly or just shoot your thoughts in the Discord chat*

---
# Tools we use
* Obsidian 
* Discord (for more frequent team meetings)
* Zoom (for more formal, bi-weekly meetings)
* For art: Aseprite (works best) but also some members use Procreate
* For dev: Unity
...
* Focus Groups
	* We gather feedback from the community members on our game.
* Game Jams
	* We hosted a Game Jam with the DINGO team on McGill campus in early 2026.
* News!?? 

*If something seems interesting to you and you would like to get involved, reach out on Discord!* 
**go-to person: Corina**
...
Don't worry! We all start somewhere. We have plenty of resources and tutorials available for you to learn. Stay curious!
