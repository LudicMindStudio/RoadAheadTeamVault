...
# Context
Happens after the grasshopper conversation
...
**Lakshmi**
	_Yawwwn... I slept well. Right.... I was up late last night studying._
**Event**
	Gets out of bed.
**Lakshmi**
	_Greg said he had something to tell me today. I better go find him._	
**Event**
	Journal updated. Player moves towards the door. 
**Lakshmi**
	_Yawn...I sure was up late... What was I doing again?_	
**Event**
	Player goes toward the stairs.
**Lakshmi**
	_Grandpa Dan?!_
**Grandpa Dan**
	`If variable is true`
		_(!) Ah! Lakshmi don't scare me! Leo already got the jump on me this morning, my heart can't take much more!_	
**Lakshmi**
	_Grandpa Dan what are you doing here?_
**Grandpa Dan**
	`If variable is true`
		_Ahem. Well I was just stopping by to let you know that Greg was waiting for you at the guild hall._
**Event**
	Grandpa Dan walks around for 2 seconds.
**Grandpa Dan**
	`If variable is true`
		_You should hurry over Lakshmi, it's an important day._
**Lakshmi**
	_Oh ok great! Thanks Grandpa Dan!_
**Event**
	Lakshmi walks 2 steps. 
**Lakshmi**
	_Whats that you placed on the table?_
**Grandpa Dan**
	`If variable is true`
		_Oh this, it's just a small gift for you Lakshmi. (While he walk away) You enjoy it now, I gotta run. I'll see you latet Lakshmi._
**Lakshmi**
	_Wow! Thank you Grandpa Dan! Enjoy your day!_
**Event**
	Journal updated. Player goes for the door. 

**Event**
	Lakshmi is outside. Players walks around to find the guild hall. Different NPCs can direct her towards the guild hall. 
	
**Event**
	As Lakshmi passes by bushes Leo jumps out.

**Lakshmi**
	_Whoa Leo! There you are. Go find Grandpa Dan he was looking for you._
**Event**
	Leo leaves and Lakshmi enters the guild hall.
...
**Receptionist**
	`If variable is true`
		_Welcome to the post guild! I'm the receptionist....ah Lakshmi it's you!. Today is a big day for you, Greg is waiting for you in his office in the back room. Good luck!_
**Lakshmi**
	_What do you mean good luck... I sure hope I'm not in trouble._
**Event**
	Lakshmi goes to the back of the guild hall. 
**Intern**
	_Dammit I dunno where I put the shipment box. The guild work is too much I'm going to get in trouble again_
**Greg**
	`If variable is true`
		_Ah Lakshmi, good morning. You slept in today, I hope you are well rested._
**Lakshmi**
	_Sorry Greg... I must have missed my alarm. Nothing too big is going on today right?._
**Greg**
	`If variable is true`
...
**Greg**
	`If variable is true`
		_Yes Lakshmi I'm sorry to say. You've been progressing too quickly and i belived you're ready to graduate._
**Lakshmi**
	_(!) Graduate !!! But there's still so much to learn! Are you sure that I'm ready?_
**Greg**
	`If variable is true`
		_I have complete faith in you, the Dolphin Bay guild has never seen such talent._
**Lakshmi**
	_Well ok! I'll give it my best then. If you're challenging me, I accept!_		
**Greg**
	`If variable is true`
...
**Lakshmi**
	_Ok, bring on question 1!_
		...
		3) What types of government did the survivors of the fog create for their new cities?
			...
			2) Monarch 
			3) Anarchy
	_All right, thats the end of the written questions. I should bring the test back to Greg to get my results._
...
**Greg**
	`If variable is true`
		_Great job Lakshmi, Let's see how you did. Hmmm... (...). You did ok Lakshmi but I've seen you do better._
**Lakshmi**
...
**Greg**
	`If variable is true`
		_Part two of your graduation evaluation will be... A practical test!._
**Lakshmi**
...
**Lakshmi**
	_Ok! Well then, I'm Lakshmi from the postal guild here to deliver your mail! Thank you for using our services and have a good day! Wow thanks again!_ 
**Intern**
	`If variable is true`
		_(...)_
**Lakshmi**
...
**Event**
	Screen blacks out and the player is now in a different room.
**Intern**
	`If variable is true`
