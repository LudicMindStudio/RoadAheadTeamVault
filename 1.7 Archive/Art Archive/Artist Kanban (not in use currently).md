...
- [x] Lakshmi Sprite 32x64 (walking cycle, facing up, down and sides) (example but can change it) [[1.7 Archive/Art Archive/Lakshmi sprite.png]] please refer to the original concept art by Michael  #Challenging @{2025-07-16} : Michael
...
%% kanban:settings
```
{"kanban-plugin":"board","list-collapse":[false,false,false,true],"tag-colors":[],"new-note-template":"Templates/ArtistKanban card Template.md"}
```
%%