...
List of all the NPCs unique to Dolphin Bay. You can find whether the description, art, dialogue and implementation have been completed for each character. 

Do we want to include greg in this list
...
**[[Guild Receptionist (Robert)]]**  -> Double check if in the game this character is a woman!
- [x] Description
- [ ] Art
	- [ ] Concept art
	- [ ] Sprite
