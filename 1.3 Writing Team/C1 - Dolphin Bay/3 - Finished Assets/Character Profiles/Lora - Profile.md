...
{>>CL: Flag for future side-quest. Super cool!<<}Lora had a major falling out with Greg five years ago over his treatment of a new recruit. The recruit is said to have journeyed out into the fog and has been lost forever. 
## Relationships
...
|DIA|[[IntroToLora_0]] 
	Lora drops a hint about the test 
		Trigger Start - LakshmiHasGraduated=False


|DIA|[[LoraCongratulates_0]]
	Lora tells Lakshmi about her dream
		Trigger Start - LakshmiHasGraduated=True
		On Clear - LoraSharesOmen = True